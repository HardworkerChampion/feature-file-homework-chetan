Feature: Book.category
  ...
  Background: I should be able to see homepage
    ...
    Scenario Outline: I should be able to see top menu tabs on homepage with categories
      ...
      Then I shoud be able to see top menu tabs with "<categories>"
      ...
      Scenario Outline: I should be able to see book page with filters
        ...
        Then I should be able to book category
        ...
        Scenario Outline: I should be able to see list of terms of each filter
          ...
          Scenario Outline: I should be able to choose any filter option with specific result
            ...
            Scenario Outline: I should be able to see product display format according display format type as per
              given picture in srs document
              Given I am on book page
              When I click on "<display format icon>"
              Then I should be able to see product display format according display format type as pergiven picturein srs document
