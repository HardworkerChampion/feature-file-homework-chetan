Feature: Nopcommerce Registration
  ...
  Background: I am on Nopcommerce Registeration page
    ...
    When I open the Url https://demo.nopcommercel.com/register
    Then I am on Nopcommerce Registration page

    Scenario Outline: I should no be able to register with invalid data on mandatory field
      ...
      Examples:
        ...
        | ""         | bakshi    | bakshi@gmail.com | 456897   | 456897           | pls enter First Name                       |
        | Rohan      | ""        | bakshi@gmail.com | 456897   | 456897           | pls enter Last Name                        |
        | Rohan      | bakshi    | ""               | 456897   | 456897           | pls enter valid email                      |
